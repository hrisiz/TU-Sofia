...
public class NewWSDLFileProxy implements localhost.NewWSDLFile.NewWSDLFile_PortType {
  private String _endpoint = null;
  private localhost.NewWSDLFile.NewWSDLFile_PortType newWSDLFile_PortType = null;
  ...
  private void _initNewWSDLFileProxy() {
    try {
      newWSDLFile_PortType = (new localhost.NewWSDLFile.NewWSDLFile_ServiceLocator()).getNewWSDLFileSOAP();
  ...
  public localhost.NewWSDLFile.NewWSDLFile_PortType getNewWSDLFile_PortType() {
    if (newWSDLFile_PortType == null)
      _initNewWSDLFileProxy();
