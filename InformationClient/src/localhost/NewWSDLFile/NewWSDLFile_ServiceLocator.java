...
public class NewWSDLFile_ServiceLocator extends org.apache.axis.client.Service implements localhost.NewWSDLFile.NewWSDLFile_Service {
    ...
    private java.lang.String NewWSDLFileSOAP_address = "http://localhost:8080/Information/services/NewWSDLFileSOAP";
    ...
    public localhost.NewWSDLFile.NewWSDLFile_PortType getNewWSDLFileSOAP() throws javax.xml.rpc.ServiceException {
    ...
    public localhost.NewWSDLFile.NewWSDLFile_PortType getNewWSDLFileSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            localhost.NewWSDLFile.NewWSDLFileSOAPStub _stub = new localhost.NewWSDLFile.NewWSDLFileSOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (localhost.NewWSDLFile.NewWSDLFile_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                localhost.NewWSDLFile.NewWSDLFileSOAPStub _stub = new localhost.NewWSDLFile.NewWSDLFileSOAPStub(new java.net.URL(NewWSDLFileSOAP_address), this);
                _stub.setPortName(getNewWSDLFileSOAPWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost/NewWSDLFile/", "NewWSDLFile");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost/NewWSDLFile/", "NewWSDLFileSOAP"));
        }
