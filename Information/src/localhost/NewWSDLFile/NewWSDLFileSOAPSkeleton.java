...
public class NewWSDLFileSOAPSkeleton implements localhost.NewWSDLFile.NewWSDLFile_PortType, org.apache.axis.wsdl.Skeleton {
    private localhost.NewWSDLFile.NewWSDLFile_PortType impl;
    ...
    */
    ...
    static {
        ...
        _oper.setElementQName(new javax.xml.namespace.QName("http://localhost/NewWSDLFile/", "NewOperation"));
        _oper.setSoapAction("http://localhost/NewWSDLFile/NewOperation");
    ...
    public NewWSDLFileSOAPSkeleton() {
        this.impl = new localhost.NewWSDLFile.NewWSDLFileSOAPImpl();
    }

    public NewWSDLFileSOAPSkeleton(localhost.NewWSDLFile.NewWSDLFile_PortType impl) {
        this.impl = impl;
    }
